...
const ReservationsList = () => {
  ...
  const participants = [
    ...
    { eventTitle: "Visite aux Résidents de Maison de Retraite", participantName: "Olfa", participantEmail: "olfagaidi89@gmail.com" },
  ];
...
L'équipe d'organisation SEAAD
    ...
    try {
      ...
      alert('Erreur lors de l\'envoi de la notification. Veuillez vérifier votre connexion ou le serveur.');
    }
  };
