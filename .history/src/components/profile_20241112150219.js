            ...
            <MDBCard>
              ...
              <MDBRow>
                ...
                <MDBRow>
                  ...
                  <MDBCol sm="9" className="text-muted">{userData.date}</MDBCol> {/* Utilise userData.phone */}
                </MDBRow>
                <hr />
                <MDBRow>
                  <MDBCol sm="3"><strong>Poste</strong></MDBCol>
                  <MDBCol sm="9" className="text-muted">{userData.poste}</MDBCol> {/* Utilise userData.category */}
                </MDBRow>
              </MDBCardBody>
            </MDBCard>
