            ...
            <MDBCard>
              <MDBCardBody className="text-center">
                ...
                <div className="d-flex justify-content-center mb-2">
                  <MDBBtn style={{ backgroundColor: '#4ECDC4' }}>Follow</MDBBtn>
          ...
          <MDBCol lg="8" className="mb-4">
            <MDBCard>
              <MDBCardBody>
                ...
                <MDBRow>
                  ...
                  <MDBCol sm="9" className="text-muted">Santé</MDBCol>
                </MDBRow>
              </MDBCardBody>
            </MDBCard>
            ...
            <MDBRow className="mt-4">
              <MDBCol md="6">
                <MDBCard>
                  <MDBCardBody>
                    <h6 className="font-italic" style={{ color: '#4ECDC4' }}>Activités Bénévolats</h6>
              ...
              <MDBCol md="6">
                <MDBCard>
                  <MDBCardBody>
                    <h6 className="font-italic" style={{ color: ''#4ECDC4'' }}>Assignment Project Status</h6>
                    <ProjectProgress title="Web Design" progress={80} />
                    <ProjectProgress title="Website Markup" progress={72} />
                    <ProjectProgress title="One Page" progress={89} />
                    <ProjectProgress title="Mobile Template" progress={55} />
