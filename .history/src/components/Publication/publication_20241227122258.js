  ...
  const staticPosts = [
    {
      ...
      content: "J'ai participé à un nettoyage de plage pendant 4 heures. C'était une expérience enrichissante.",
      volunteerTime: "12/12/2024",
      image: "https://via.placeholder.com/150", // Exemple d'image statique
      date: "2024-12-15",
  ...
  return (
    <div className="publication-page">
      ...
      <div className="publication-form">
        ...
        {/* Ajouter la durée de l'expérience */}
        <input
          type="text"
          value={volunteerTime}
          onChange={handleVolunteerTimeChange}
          placeholder="Durée de l'expérience (ex: 2 heures)"
          className="input-field"
        />
