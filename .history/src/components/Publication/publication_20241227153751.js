...
const Publication = () => {
  ...
  const [imageUrl, setImage] = useState(null); // Pour stocker l'image
  ...
  const staticPosts = [
    {
      ...
      imageUrl: "/images/plage.avif", // Exemple d'image statique
    ...
    <div className="publication-page">
      ...
      <div className="publication-form">
        ...
        <div className="image-upload">
          ...
          />
          {imageUrl && <img src={imageUrl} alt="Aperçu" className="image-preview" />}
        </div>
