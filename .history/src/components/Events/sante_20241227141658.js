...
const eventsData = [
  {
    id: 1,
    title: "Cours de Cuisine Santé",
    description: "Un atelier de cuisine pour apprendre à préparer des repas sains et délicieux à la maison.",
    date: "12/05/2025",
    participants: 60,
    imageUrl: "/images/health.avif",
  },
  {
    id: 2,
    title: "Challenge Vélo - Objectif 100km",
    description: "Participez à notre défi vélo et atteignez l'objectif de 100 km pour promouvoir l'activité physique et le bien-être.",
    date: "30/04/2025",
    participants: 70,
    imageUrl: "/images/velo.avif",
  },
  {
    id: 3,
    title: "Séminaire sur la Méditation",
    description: "Un séminaire sur les bienfaits de la méditation pour la réduction du stress et l'amélioration de la concentration.",
    date: "15/03/2025",
    participants: 55,
    imageUrl: "/images/seminaire.avif",
  },
  {
    id: 4,
...
export default function Sante() {
  ...
  return (
    <Box padding={2}>
      ...
      Rejoignez-nous pour une journée dédiée à la santé et au bien-être. Profitez de consultations gratuites, de dépistages, et d’ateliers interactifs animés par des professionnels de la santé. Découvrez des conseils pratiques pour améliorer votre qualité de vie et prenez part à des activités qui encouragent un mode de vie sain.
      </Typography>
