...
const eventsData = [
  ...
  {
    id: 1,
    title: "Échange Solidaire de Médicaments",
    description: "Un événement communautaire pour encourager le partage de médicaments non utilisés, dans le respect des réglementations en vigueur. Venez échanger ou donner des médicaments inutilisés afin de soutenir ceux dans le besoin, tout en promouvant la solidarité et la santé pour tous.",
    participants: 80,
    date: "05/05/2025",
    imageUrl: "/images/medication-exchange.avif",
  },
  {
    id: 2,
