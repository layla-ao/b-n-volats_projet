...
export default function Animaux() {
  ...
  return (
    <Box padding={2}>
      ...
      Participez à notre événement dédié aux animaux, un moment unique pour célébrer nos amis à quatre pattes !<br/ Profitez d’activités amusantes, de stands éducatifs, d'adoptions responsables, et de rencontres avec des experts en soin animalier.
