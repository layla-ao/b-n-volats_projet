...
export default function Sociale() {
  ...
  return (
    <Box padding={2}>
      ...
      Rejoignez-nous pour un événement social visant à renforcer les liens communautaires et à promouvoir la solidarité. <br/> Ensemble, sensibilisons à la protection et au bien-être des animaux.<br/>
      </Typography>
