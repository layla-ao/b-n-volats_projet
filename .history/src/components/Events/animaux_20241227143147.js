...
const eventsData = [
  ...
  {
    id: 3,
    title: "Exposition Canine",
    description: "Venez découvrir des races de chiens exceptionnelles lors de notre exposition canine. C'est un événement idéal pour les amoureux des animaux et ceux qui souhaitent en savoir plus sur les races.",
    participants: 60,
    date: "18/02/2025",
    imageUrl: "/images/expositioncanine.avif",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    participants: 120,
    date: "22/03/2025",
    imageUrl: "/images/dressagecanin.avif",
  },
];
...
export default function Animaux() {
  ...
  return (
    <Box padding={2}>
      ...
      Participez à notre événement dédié aux animaux, un moment unique pour célébrer nos amis à quatre pattes ! Profitez d’activités amusantes, de stands éducatifs, d'adoptions responsables, et de rencontres avec des experts en soin animalier.<br/> Découvrez des conseils pratiques pour améliorer votre qualité de vie et prenez part à des activités qui encouragent un mode de vie sain.
            <br/>
            </Typography>
