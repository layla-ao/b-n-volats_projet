...
import Login from './components/Auth/Login/L';
...
function Content({ userData, activeSection, updateUserData, handleLogin, handleLogout }) {
    ...
    <div className="App">
      ...
      <div className="main-content">
        ...
        <Routes>
          ...
          <Route path="/profile/edit-profile" element={<EditProfile userData={userData} updateUserData={updateUserData} />} />
      ...
      {/* Display Footer and Chatbot only if it's not the Dashboard */}
      {!isDashboard && <Footer />}
      {!isDashboard && <Chatbot />}
    </div>
  );
